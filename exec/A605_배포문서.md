...
CLOUD_AWS_S3_BUCKET=collabit-s3
        ...
        stage('Deploy') {
            steps {
                withCredentials([
                    ...
                    sh """
                        scp -i \${SSH_KEY} -o StrictHostKeyChecking=no collabit-server/.env ubuntu@13.125.80.193:/home/ubuntu/collabit/collabit-server/
                        ssh -i \${SSH_KEY} -o StrictHostKeyChecking=no ubuntu@13.125.80.193 "\
        ...
        stage('Deploy') {
            steps {
                withCredentials([
                    ...
                    sh """
                        scp -i \${SSH_KEY} -o StrictHostKeyChecking=no collabit-ai/.env ubuntu@13.125.80.193:/home/ubuntu/collabit/collabit-ai/
                        ssh -i \${SSH_KEY} -o StrictHostKeyChecking=no ubuntu@13.125.80.193 "\
